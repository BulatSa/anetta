...
<section class="experience-sec def-sec">
	<div class="experience container">
		<div class="page-title anim">
			...
			<div class="user-content">
				<p>Вы могли видеть меня соведущей в программах «Дом вверх дном» и «Женщина руководство по эксплуатации. Прием по личным вопросам». Также я выступаю в качестве консультанта на передачах «Пусть говорят», «Я подаю на развод», «Модный приговор» и других.</p>
			</div>
		</div>
		...
		<div class="clients__list">
			<div class="clients__item">
				...
				<div class="clients__item-text anim">
					...
					<div class="user-content">
						...
						<p>Я консультирую людей, которые стремятся к успеху. Они хотят изменить модель поведения и расширить свои границы. Я помогаю им избавиться от внутренних и внешних рамок и развить способности, которые притянут перемены и изменят жизнь в лучшую сторону.</p>
					</div>
				</div>
			</div>
			<div class="clients__item">
				...
				<div class="clients__item-text anim">
					...
					<div class="user-content">
						...
						<p>Вы хотите обрести новые цели и новые смыслы, но не знаете, с чего начать. Вы испытываете чувство вины и подавленность, но не понимаете, что не так. Вместе мы найдем ответы на эти вопросы и улучшим все сферы — от отношений до самореализации.</p>
					</div>
				</div>
			</div>
			...
			<div class="clients__item clients__item--last">
				...
				<div class="clients__item-text anim">
					...
					<div class="user-content">
						<h3>Семейные пары</h3>
						<p>Я расскажу, как обновить отношения, если брак утратил былую искру и превратился в рутину. С моей помощью вы сможете избежать возможных ошибок, вернете теплое эмоциональное общение с близким человеком и, наконец, вырвитесь из замкнутого круга.</p>
					</div>
				</div>
			</div>
			<div class="clients__item clients__item--last">
				...
				<div class="clients__item-text anim">
					...
					<div class="user-content">
						<h3>Люди бизнеса</h3>
						<p>Я помогаю бизнесменам проанализировать ошибки, которые мешают достичь большего, и преломить ситуацию в свою пользу. Вместе с каждым клиентом мы учимся ставить амбициозные цели, правильно раскрывать собственный потенциал и не бояться успехов в работе.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="video__item video__item--2">
				...
				<div class="video__item-info-wrap">
					...
					<div class="video__item-info">
						...
						<div class="user-content user-content--mini">
							<p>Я научу отличать гармоничные отношения от токсичных и помогу спасти ваш брак. Мы победим стереотипы поведения, научимся говорить с партнером на одном языке и сократим дистанцию между вами и вашим супругом.</p>
						</div>
					</div>
				</div>
				<div class="video__item-contact">
	...
	<div class="confidence container">
		<div class="confidence__info anim">
			<div class="page-title page-title--left">
				...
				<div class="user-content">
					<p>Я считаю лишним просить человека оставить или опубликовать отзыв о моей работе. Прежде всего мне важно помочь клиентам обрести себя, и я не буду использовать результат совместной работы в собственных целях.</p>
				</div>
			</div>
		</div>
	</div>
